...
def streamlit_menu():
    with st.sidebar:
        selected = option_menu(
            ...
            options=["General", "Entertainment", "Business", "Health",
                     "Science", "Sports", "Technology"],  # required
            icons=["house", "emoji-sunglasses", "building", "capsule",
                   "lightbulb-fill", "trophy", "cpu"],  # optional
...
if selected == "General":
    summaries = get_top_headlines(5, apiKey=API_KEY, sortBy='publishedAt',
                                  country='us',
                                  category="General")
